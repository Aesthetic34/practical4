 ...
 * 
 */
@WebServiceClient(name = "CalculatorWs", targetNamespace = "http://kk.com/", wsdlLocation = "http://localhost:8080/CalcWebService/CalculatorWs?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://kk.com/", "CalculatorWs");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalcWebService/CalculatorWs?WSDL");
    ...
    public CalculatorWs getCalculatorWsPort() {
        return super.getPort(new QName("http://kk.com/", "CalculatorWsPort"), CalculatorWs.class);
    }
    ...
    public CalculatorWs getCalculatorWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://kk.com/", "CalculatorWsPort"), CalculatorWs.class, features);
    }
